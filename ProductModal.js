        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content border-0">
            ...
            <div class="modal-body">
              <div class="row">
                <div
                  v-if="Array.isArray(tempProduct.imageUrl)"
                  class="col-sm-4"
                >
                  <div class="mb-2">
                    <div
                  ...
                  <div
                    v-if="tempProduct.imageUrl.length === 0 || tempProduct.imageUrl[tempProduct.imageUrl.length - 1]"
                  >
                    <!-- 最後一個有值的情況下 -->
                    <button
            ...
            <div class="modal-footer">
              ...
              <button @click="postData" type="button" class="btn btn-primary">
                確認
              </button>
            </div>
          </div>
